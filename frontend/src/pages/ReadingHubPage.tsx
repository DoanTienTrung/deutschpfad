  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <h2 className="font-display text-3xl font-bold text-ink">
        Luyện <span className="text-accent-deep">đọc</span> tiếng Đức
      </h2>
      <p className="mt-2 text-sm text-muted">
        Luyện đọc qua bài báo, trích đoạn sách theo chủ đề đời sống, hoặc luyện trực tiếp với dữ
        liệu đề thi mẫu chính thức Goethe-Institut để làm quen với đúng định dạng thi thật.
      </p>

      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <Link
          to="/app/reading/articles"
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold uppercase tracking-wide">Đọc qua Sách, Báo</p>
              <p className="mt-0.5 text-xs text-canvas/70">Bài báo, trích đoạn sách đời sống</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold uppercase tracking-wide">Đọc qua Đề thi</p>
